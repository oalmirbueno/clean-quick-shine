...
import { Eye, FileCheck, Tag, Wrench, Building2, HeadphonesIcon, BarChart3, Shield, ShieldCheck, Settings, LogOut, X, Bell, Map } from "lucide-react";
...
const moreItems = [
  { icon: Map, label: "Mapa da operação", path: "/admin/map" },
