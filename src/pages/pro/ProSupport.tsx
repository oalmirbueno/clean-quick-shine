      ...
      {showNewTicket && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4">
          ...
          <div className="relative bg-card rounded-t-3xl sm:rounded-2xl border border-border/60 p-6 w-full max-w-md shadow-lg animate-slide-up">
            <button onClick={() => setShowNewTicket(false)} className="absolute top-4 right-4 p-1.5 rounded-lg hover:bg-accent transition-colors"><X className="w-5 h-5 text-muted-foreground" /></button>
