                  ...
                  <div className="border-t border-border divide-y divide-border">
                    ...
                    {group.documents.map((doc, idx) => {
                      ...
                      <div key={doc.id} className={cn(
                        "flex items-center gap-3 p-3 px-4 hover:bg-accent/20 transition-colors",
            ...
            <div className="flex flex-wrap gap-1.5">
              {[
                ...
                <button
                  ...
                  className="text-xs px-2.5 py-1.5 rounded-lg border border-border hover:bg-accent transition-colors text-muted-foreground hover:text-foreground"
                >
                  {reason}
                </button>
              ))}
